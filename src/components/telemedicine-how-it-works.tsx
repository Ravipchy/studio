...
const steps = [
  { icon: UserCheck, title: "Choose Your Specialist", description: "Select from our list of verified and experienced doctors." },
  { icon: CalendarDays, title: "Select Date & Time", description: "Book a slot that is convenient for you." },
  { icon: Video, title: "Securely Consult Online", description: "Join the video call for a private consultation." }
];

export function TelemedicineHowItWorks() {
  return (
