...
import { UserPlus, Stethoscope, ShieldCheck } from "lucide-react";
...
const steps = [
  {
    ...
    description: "Sign up and create your profile to get started with our services."
  },
  {
    icon: Stethoscope,
  ...
  },
  {
    icon: ShieldCheck,
    title: "Receive Care",
    description: "Get professional healthcare from our team of expert doctors and specialists."
  }
];
